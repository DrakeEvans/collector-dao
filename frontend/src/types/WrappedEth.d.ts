...
interface WrappedEthInterface extends ethers.utils.Interface {
  functions: {
...
export class WrappedEth extends BaseContract {
  ...
  estimateGas: {
    ...
    faucet(_amount: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
